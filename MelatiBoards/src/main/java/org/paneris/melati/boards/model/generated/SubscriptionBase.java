...
public abstract class SubscriptionBase extends Persistent {
  ...
  public void setUserTroid(Integer raw)
      throws AccessPoemException {
    _getSubscriptionTable().getUserColumn().getType().assertValidRaw(raw);
    writeLock();
    setUser_unsafe(raw);
  }
  ...
  public void setBoardTroid(Integer raw)
      throws AccessPoemException {
    _getSubscriptionTable().getBoardColumn().getType().assertValidRaw(raw);
    writeLock();
    setBoard_unsafe(raw);
  }
  ...
  public void setStatusTroid(Integer raw)
      throws AccessPoemException {
    _getSubscriptionTable().getStatusColumn().getType().assertValidRaw(raw);
    writeLock();
    setStatus_unsafe(raw);
  }
  ...
  public MembershipStatus getStatus()
    ...
    return troid == null ? null :
        getBoardsDatabase().getMembershipStatusTable().getMembershipStatusObject(troid);
  }

  public void setStatus(MembershipStatus cooked)
      throws AccessPoemException {
    setStatusTroid(cooked == null ? null : cooked.troid());
  }
