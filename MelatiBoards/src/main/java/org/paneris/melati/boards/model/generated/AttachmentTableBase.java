...
public class AttachmentTableBase extends Table {
  ...
  protected void init() throws PoemException {
    ...
    defineColumn(col_message =
        new Column(this, "message", new ReferencePoemType(((BoardsDatabase)getDatabase()).getMessageTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
    ...
    defineColumn(col_type =
        new Column(this, "type", new ReferencePoemType(((BoardsDatabase)getDatabase()).getAttachmentTypeTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
