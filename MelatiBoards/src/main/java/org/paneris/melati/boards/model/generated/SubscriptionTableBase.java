...
public class SubscriptionTableBase extends Table {
  ...
  protected void init() throws PoemException {
    ...
    defineColumn(col_user =
        new Column(this, "user", new ReferencePoemType(((BoardsDatabase)getDatabase()).getUserTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
    ...
    defineColumn(col_board =
        new Column(this, "board", new ReferencePoemType(((BoardsDatabase)getDatabase()).getBoardTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
    ...
    defineColumn(col_status =
        new Column(this, "status", new ReferencePoemType(((BoardsDatabase)getDatabase()).getMembershipStatusTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
