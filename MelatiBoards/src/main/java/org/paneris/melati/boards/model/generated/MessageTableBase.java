...
public class MessageTableBase extends Table {
  ...
  protected void init() throws PoemException {
    ...
    defineColumn(col_author =
        new Column(this, "author", new ReferencePoemType(((BoardsDatabase)getDatabase()).getUserTable(), false), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
    ...
    defineColumn(col_parent =
        new Column(this, "parent", new ReferencePoemType(((BoardsDatabase)getDatabase()).getMessageTable(), true), DefinitionSource.dsd) { 
          public Object getCooked(Persistent g)
              throws AccessPoemException, PoemException {
